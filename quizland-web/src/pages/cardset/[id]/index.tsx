...
const ModeBtn = ({
    ...
    <a href={href} className={(disabled ? ' pointer-events-none cursor-not-allowed' : '')}>
        <div className={'font-semibold text-center md:text-left md:text-xl rounded-lg p-3 md:p-4 flex bg-secondary hover:scale-[1.05] duration-200 '}>
            {children}
        </div>
    </a>
)
            ...
            <SectionContainer>
                ...
                <Section className={'grid grid-cols-3 gap-4'}>
                    <ModeBtn href={`/cardset/${cardSet.id}/flashcard`}>
                        <svg viewBox={'0 0 180 180'} className={'h-7 mr-2 hidden md:block'} xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <ModeBtn href={'/cardset/' + cardSet.id + '/match'} disabled={true}>
                        <svg className={"h-7 mr-2 hidden md:block"} viewBox={'0 0 32 32'} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ModeBtn href={'/cardset/' + cardSet.id + '/learn'} disabled={true}>
                        <svg viewBox={'0 0 16 16'} className={'w-7 mr-2 hidden md:block'} xmlns="http://www.w3.org/2000/svg">
