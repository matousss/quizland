            ...
            <SectionContainer>
                ...
                <Section className={'grid grid-cols-3 gap-4'}>
                    <ModeBtn href={`/cardset/${cardSet.id}/flashcard`}>
                        <svg viewBox={'0 0 180 180'} className={'h-7 mr-2'} xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <ModeBtn href={'/cardset/' + cardSet.id + '/match'} disabled={true}>
                        <svg className={"h-7 mr-2"} viewBox={'0 0 32 32'} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ModeBtn href={'/cardset/' + cardSet.id + '/learn'} disabled={true} xmlns="http://www.w3.org/2000/svg">
