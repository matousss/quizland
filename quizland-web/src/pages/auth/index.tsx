...
const Auth = ({error_codes}: Props) => {
    ...
    return (
        <div className={'bg-gray-800 md:flex'}>
            <Tab.Group as={"div"}
                       className={'h-full md:h-1/2 md:w-1/2 text-gray-300 bg-gray-700 bg-white md:rounded-md m-auto divide-y flex flex-col drop-shadow-xl'}>
                    <Tab.List className={'w-full grow-0'}>
                        <div className={'flex'}>
                        ...
                        <Tab.Panel className={'flex flex-col grow'}>
                            ...
                            <div className={'flex flex-col grow'}>
                                ...
                                <div className={'mx-auto mt-[20%] md:my-auto pb-5 w-2/3 lg:w-2/5 gap-y-3'}>
                                    ...
                                    <GoogleOAuthProvider clientId={process.env.NEXT_PUBLIC_GOOGLE_REDIRECT_URI as string}>
                                        <GoogleButton className={'rounded-md border bg-white text-black mx-auto w-full mb-3'}/>
                                    </GoogleOAuthProvider>
                                    <SocialButton provider={'More coming soon...'} className={'rounded-md border-none bg-gray-600 mx-auto w-full'}/>
                                 </div>
                            </div>
